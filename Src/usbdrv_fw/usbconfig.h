 ...
 */
#define USB_CFG_MAX_BUS_POWER           210
...
#define  USB_CFG_VENDOR_ID__INT  5824		/* = 0x16c0 = 5824 = voti.nl */
 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xdc, 0x05 /* = 0x05df = 1500 = obdev's shared PID for Vendor Class devices with libusb */
#define  USB_CFG_DEVICE_ID__INT  1500		/* = 0x05df = 1500 = obdev's shared PID for Vendor Class devices with libusb */
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'D', 'F', '4', 'I', 'A', 'H', '-', '1', '0', 'M', 'H', 'z', '-', 'R', 'e', 'f', '-', 'O', 's', 'c'
